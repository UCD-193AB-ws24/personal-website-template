...
// POST /api/db/drafts/increase-view-count?username=string
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (username === null) {
      throw new Error("No username found in the request's query parameters");
    }
    ...
    const publishedDraftNumber =
      usersSnapshot.docs[0].data().publishedDraftNumber;
