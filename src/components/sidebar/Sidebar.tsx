...
const sidebarItems = [
  { id: 1, type: 'textbox', name: 'Textbox', description: 'Add a text box.', icon: <TextIcon /> },
  { id: 2, type: 'schoolInfo', name: 'School Information', description: 'Add information about your schooling.', icon: <SchoolIcon /> },
];
